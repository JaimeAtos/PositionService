...
public class
	GetResourcePositionByIdQueryHandler : IRequestHandler<GetResourcePositionByIdQuery, Response<ResourcePositionDto>>
{
	...
	public Task<Response<ResourcePositionDto>> Handle(GetResourcePositionByIdQuery request,
	...
	private async Task<Response<ResourcePositionDto>> ProcessHandle(GetResourcePositionByIdQuery request,
		CancellationToken cancellationToken)
	{
